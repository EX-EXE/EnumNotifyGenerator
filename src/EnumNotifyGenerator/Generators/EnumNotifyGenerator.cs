...
""");
		...
		enumCommentBuilder.AppendLine($"\t/// Generated by {nameof(EnumNotifyGenerator)}.<br/>");
		enumCommentBuilder.AppendLine($"\t/// <remarks>");
		foreach (var fieldInfo in fieldInfos)
		{
			enumCommentBuilder.AppendLine($"\t/// ・{fieldInfo.FieldSymbol.Type.ToDisplayString(SymbolDisplayFormat.MinimallyQualifiedFormat)} {fieldInfo.PropertyName}<br/>");
		}
		enumCommentBuilder.AppendLine($"\t/// </remarks>");
		enumCommentBuilder.AppendLine($"\t/// </summary>");
